...
kit_recon_tl =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","tf_microdagr","tf_rf7800str_2",NIGHT_ITEM("rhsusf_ANPVS_15"),"Rangefinder"],
...
kit_recon_jtac =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","tf_microdagr","tf_rf7800str_2",NIGHT_ITEM("rhsusf_ANPVS_15"),"Laserdesignator"],
...
kit_recon_ar =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","tf_microdagr","tf_rf7800str_2",NIGHT_ITEM("rhsusf_ANPVS_15")],
	["<UNIFORM ITEMS >> ",[["ACE_DAGR",1],["ACE_quikclot",4],["ACE_morphine",1],["ACE_epinephrine",1],["ACE_tourniquet",2],["ACE_fieldDressing",5],["ACE_packingBandage",3],["ACE_MapTools",1]]],
...
kit_pilot =
	...
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","tf_rf7800str_1","ItemGPS",NIGHT_ITEM("rhsusf_ANPVS_15")],
	["<UNIFORM ITEMS >> ",[["ACE_MapTools",1],["ACE_EarPlugs",1],["ACE_fieldDressing",10],["ACE_packingBandage",5],["ACE_tourniquet",2],["ACE_morphine",1],["ACE_epinephrine",1],["ACE_quikclot",5]]],
...
kit_blufor_common =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ",NIGHT_ITEM("rhsusf_ANPVS_15")],
