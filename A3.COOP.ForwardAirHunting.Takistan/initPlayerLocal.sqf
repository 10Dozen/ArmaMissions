...
[] spawn {
	...
	<br /><br /><br />If 3d icon isn't drawn or you forgot to turn option on in Mission Parameters - you may <executeClose expression='[] execVM ""dzn_jtac\dzn_jtac_init.sqf""'>Enable it</executeClose> here."]];
