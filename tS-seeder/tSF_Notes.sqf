...
TOPIC(tSF_note_enableArtilleryControl, "Запрос MEDEVAC")
...
<br />5. Количество раненых, тип > <font color='#9E9E9E'> </font>
<br />6. Безопасность в зоне посадки > <font color='#9E9E9E'> </font>
<br />7. Метод обозначения зоны посадки > <font color='#9E9E9E'> </font>
<br />8. Статус\национальность пациентов > <font color='#9E9E9E'> </font>
<br />9. РXБ обстановка > <font color='#9E9E9E'> </font>
