...
tSF_note_enableViewDistance			= true;
...
<br />3. Приоритет > <font color='#9E9E9E'>A - Срочный (до 2 ч.), B - Приоритетный (до 4 ч.), C - Обычный (до 12 ч.), D - Не срочный (до 24 ч.)</font>
...
<br />5. Количество раненых, тип > <font color='#9E9E9E'>L 2, A 0 (Л - легко, А - тяжелораненые, число - кол-во раненых) </font>
...
<br />7. Метод обозначения зоны посадки > <font color='#9E9E9E'>A - Пенли, B - Пиротехнический сигнал, C - дымовой сигнал, D - Нет, E - Другое </font>
...
<br />
<br /><font color='#5E5E5E'>Не передавайте номера линий и их заголовки. Передавайте только индексы (букву) для линий 3-9 (т.е. говорите 'D' вместо 'Пункт 3. Не срочный').<br /></font>"
END

TOPIC(tSF_note_enableViewDistance, "Типы СВУ")
"<font color='#12C4FF' size='14'>Обзор</font>
<br />На территории Такистана используются преимущественно 3 типа СВУ (самодельных взрывных устройств) собранных по похожим схемам.
<br />
<br /><font color='#12C4FF' size='14'>Тип 1 - Порядок разминирования</font>
<br />1) Cut red wire
<br />2) Unplug battery
<br />3) Unplug timer/receiver
<br />4) Cut green wire
<br />5) Unplug detonator
<br />
<br /><font color='#12C4FF' size='14'>Тип 2 - Порядок разминирования</font>
<br />1) Unplug battery
<br />2) Cut green wire
<br />3) Unplug timer/receiver
<br />4) Cut red wire
<br />5) Unplug detonator
<br />
<br /><font color='#12C4FF' size='14'>Тип 3 - Порядок разминирования</font>
<br />1) Cut green wire
<br />2) Unplug battery
<br />3) Cut red wire
...
<br />2) Cut red wire
<br />3) Unplug battery
<br />4) Unplug detonator OR Unplug timer/receiver
<br />5) Unplug detonator OR Unplug timer/receiver
"
END
